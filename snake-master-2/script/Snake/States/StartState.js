...
;(function(App, window, document, undefined) {
	...
	App.StartState = function(phaser) {
		...
		this.preload = function() {
			this.phaser.load.image('gameover', 'gfx/gameover-2.png');
			this.phaser.load.image('point', 'gfx/point-2.png');
			this.phaser.load.image('playerball', 'gfx/player-ball-2.png');
			this.phaser.load.image('play', 'gfx/play-3.png');
		};
